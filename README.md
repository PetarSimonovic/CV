...
**Log-Line**: An iOS app that generates story synopses that can be used as prompts for writers of fiction. Initially written as a web app i JavaScript, then redeveloped in Swift and Xcode with additional functionality. 
